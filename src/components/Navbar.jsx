            ...
            {light ? (
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="white"
                  className={`icon icon-tabler icons-tabler-filled icon-tabler-moon hover:-rotate-45 transition-all duration-200 ease-in-out`}
                >
                  <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          ...
          >
            ...
            <div className="flex flex-col justify-between h-[85vh] p-5 relative w-full">
              ...
              <nav>
                ...
                <button
                  onClick={toggleTheme}
                  className={`py-3 px-3 rounded-md cursor-pointer font-medium ${
                    light
                      ? "bg-sky-500 text-neutral-50"
                      : "bg-blue-500 text-white"
                  } animation`}
                >
                  Change {light ? "Dark Mode" : "Light Mode"}
                </button>
              </nav>
